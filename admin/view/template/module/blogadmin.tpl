<div id="blog-menu_admin" style="display: none;">
      <li id="seocms-menu">
      <a href="<?php echo $url_module; ?>" class="top"><i class="fa fa-list fa-fw"></i><span><?php echo $url_module_text; ?></span></a>
        ...
        <li><a href="<?php echo $url_jetcache; ?>"><?php echo $language->get('jetcache_menu_text'); ?></a></li>
        <?php } ?>

        <li><a href="<?php echo $url_schemes; ?>"><?php echo $language->get('tab_general'); ?></a></li>
        <li><a href="<?php echo $url_widgets; ?>"><?php echo $language->get('tab_list'); ?></a></li>
        ...
        <li><a href="<?php echo $url_fields; ?>"><?php echo $language->get('entry_fields_editor'); ?></a></li>
        <?php } ?>


		<li><a href="<?php echo $language->get('url_download_new_version'); ?>"><?php echo $url_forum_update_text; ?></a></li>
