...
/***************************************/
	...
	private function loadadminmenu() {
		...
		$this->data['url_schemes'] = $this->url->link('module/blog/schemes' . '&token=' . $this->data['token']);
		$this->data['url_widgets'] = $this->url->link('module/blog/widgets' . '&token=' . $this->data['token']);
        $this->data['url_jetcache'] = $this->url->link('jetcache/jetcache' . '&token=' . $this->data['token']);
        $this->data['url_fields'] = $this->url->link('catalog/fields' . '&token=' . $this->data['token']);
