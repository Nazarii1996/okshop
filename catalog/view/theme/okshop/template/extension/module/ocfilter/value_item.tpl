...
<?php if ($value['selected']) { ?>
  ...
  <label id="v-<?php echo $value['id']; ?>" data-option-id="<?php echo $option['option_id']; ?>">
                                        <input checked type="checkbox" name="ocf[<?php echo $option['option_id']; ?>]" value="<?php echo $value['params']; ?>" class="ocf-target" autocomplete="off" >
...
<?php } else if ($value['count']) { ?>
  ...
  <div>
  <label id="v-<?php echo $value['id']; ?>" data-option-id="<?php echo $option['option_id']; ?>">
                                        <input type="checkbox" name="ocf[<?php echo $option['option_id']; ?>]" value="<?php echo $value['params']; ?>" class="ocf-target" autocomplete="off" >
                                        <?php echo $value['name']; ?></label>
                                    </div>
