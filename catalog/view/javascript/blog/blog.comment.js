...
function comment_write(event) {
    ...
    var data_form = $(".answerpop").find('form').serialize();
    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            $('#' + prefix + 'comment_work_' + myid).before('<div class="attention alert alert-attention">'+text_wait+'<img src="catalog/view/theme/' + 'default' + '/image/aloading16.png" alt="">' +  '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
$(document).ready(function () {
    ...
    if ($.isFunction($.fn.on)) {
        $(document).on('click', '.comment_reply', function () {
            ...
            $(".answerpop").find('.block').attr('id',acr['prefix'] + 'comment_work_' + cid);
