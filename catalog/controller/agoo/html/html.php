...
class ControllerAgooHtmlHtml extends Controller
{
	...
	public function index($data)
	{
		...
		if (isset($this->data['settingswidget']['manufacturers']) && !empty($this->data['settingswidget']['manufacturers'])) {
			if ($this->data['route'] == 'product/product' && isset($this->request->get['product_id'])) {
				$manufacturers = $this->model_record_blog->getManufacturersByProduct($this->request->get['product_id']);
			}
		...
		if (isset($this->data['settingswidget']['blogs']) && !empty($this->data['settingswidget']['blogs'])) {
			...
			if (!isset($this->data['settingswidget']['categories']) && empty($this->data['settingswidget']['categories']) && !isset($this->data['settingswidget']['manufacturers']) && empty($this->data['settingswidget']['manufacturers'])) {
		...
		if ((!isset($this->data['settingswidget']['blogs']) ||  empty($this->data['settingswidget']['blogs'])) && (!isset($this->data['settingswidget']['categories']) ||  empty($this->data['settingswidget']['categories'])) && (!isset($this->data['settingswidget']['manufacturers']) ||  empty($this->data['settingswidget']['manufacturers']))) {
			$html_flag_work = true;
		}
