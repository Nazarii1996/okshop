...
if (!class_exists('ControllerCommonSeoBlog')) {
	class ControllerCommonSeoBlog extends Controller {
		...
		public function rewrite($link) {
			...
			if (isset($data['route']) || isset($data['record_id']) || isset($data['blog_id'])) {

				if (!isset($data['route']) && isset($data['blog_id'])) {
					$data['route'] =  "record/blog";
					$url_data['path'] = '';
				}

				if (!isset($data['route']) && isset($data['record_id'])) {
					$data['route'] =  "record/record";
					$url_data['path'] = '';
				}

				if ($data['route'] == "record/record" || $data['route'] == "record/blog" || isset($data['record_id']) || isset($data['blog_id'])) {
