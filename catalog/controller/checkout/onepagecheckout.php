...
class ControllerCheckoutOnepagecheckout extends Controller
{
    ...
    public function index()
    {
        ...
        $data['cart_total'] = 0;
          $this->document->addLink('/catalog/view/theme/okshop/css/order.css','stylesheet');
               $this->document->addScript('/catalog/view/theme/okshop/js/order.min.js','footer');
      ...
      /*  if ($this->customer->isLogged()) {
        ...
        foreach ($products as $i => $product) {
            ...
            $products[$i]['total'] = $this->currency->format($product['total'], $this->session->data['currency']);
            $image=$this->model_tool_image->resize($product['image'],125,85);
